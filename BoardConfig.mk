...
BOARD_PHICOMM_C230WXX_AUDIO_CODEC := true
BOARD_USES_ALSA_AUDIO := true
AUDIO_FEATURE_DISABLED_ANC_HEADSET := false
AUDIO_FEATURE_DISABLED_PROXY_DEVICE := false
AUDIO_FEATURE_DISABLED_FM := false
AUDIO_FEATURE_DISABLED_USBAUDIO := false
AUDIO_FEATURE_DISABLED_HFP := false
AUDIO_FEATURE_DISABLED_CUSTOMSTEREO := false
AUDIO_FEATURE_ENABLED_SSR := false
AUDIO_FEATURE_DISABLED_MULTI_VOICE_SESSIONS := false
AUDIO_FEATURE_DISABLED_INCALL_MUSIC := false
AUDIO_FEATURE_DISABLED_COMPRESS_VOIP := false
AUDIO_FEATURE_DISABLED_COMPRESS_CAPTURE := false
AUDIO_FEATURE_DISABLED_DS1_DOLBY_DDP := false
AUDIO_FEATURE_DISABLED_WMA_OFFLOAD_DISABLED := false
AUDIO_FEATURE_DISABLED_MP2_OFFLOAD := false
AUDIO_FEATURE_ENABLED_MULTIPLE_TUNNEL := false
AUDIO_FEATURE_ENABLED_ULTRA_LOW_LATENCY := false
