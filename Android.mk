...
FIRMWARE_WLAN_CONF_SYMLINKS := $(addprefix $(TARGET_OUT_ETC)/firmware/wlan/prima/,$(notdir $(FIRMWARE_WLAN_CONF)))
$(FIRMWARE_WLAN_CONF_SYMLINKS): $(LOCAL_INSTALLED_MODULE)
	@echo "WLAN Configuration link: $@"
	@mkdir -p $(dir $@)
	@rm -rf $@
	$(hide) ln -sf /data/misc/wifi/$(notdir $@) $@

ALL_DEFAULT_INSTALLED_MODULES += $(FIRMWARE_WLAN_CONF_SYMLINKS)
